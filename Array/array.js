...
// In JavaScript, an array is a collection of elements that can store multiple values in a single variable. These values (or elements) can be of any type, such as numbers, strings, objects, or even other arrays (nested arrays). Arrays are zero-indexed, meaning that the first element is at index 0, the second at index 1, and so on.

// JavaScript arrays are dynamic, meaning their size can change, and they come with several built-in methods that make it easy to manipulate and iterate over the elements.

// Key Characteristics:
// Ordered Collection: The elements are stored in a specific order, and you can access them by their index.
// Dynamic: Arrays in JavaScript are resizable, so you can add or remove elements as needed.
// Heterogeneous: Arrays can hold elements of different types (e.g., numbers, strings, objects).
